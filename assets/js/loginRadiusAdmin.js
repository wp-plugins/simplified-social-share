...
function loginRadiusToggleForm(val) {
    if (val == 'login') {
        ...
        document.getElementById('loginRadiusFormTitle').innerHTML = 'Login with your LoginRadius Account to change settings as per your requirements!';
        ...
        document.getElementById('loginRadiusFormTitle').innerHTML = 'Create a LoginRadius Account';
    ...
    for (var i = 0; i < loginRadiusSharingHorizontalSharingProviders.length; i++) {
        if (loginRadiusSharingHorizontalSharingProviders[i].checked) {
            ...
            if (checkCount >= 10) {
                ...
                setTimeout(function() {
                    document.getElementById('loginRadiusHorizontalSharingLimit').style.display = 'none';
                }, 2000);
                return;
            }
        }
    ...
    for (var i = 0; i < loginRadiusSharingVerticalSharingProviders.length; i++) {
        if (loginRadiusSharingVerticalSharingProviders[i].checked) {
            ...
            if (checkCount >= 10) {
                ...
                setTimeout(function() {
                    document.getElementById('loginRadiusVerticalSharingLimit').style.display = 'none';
                }, 2000);
                return;
            }
        }
